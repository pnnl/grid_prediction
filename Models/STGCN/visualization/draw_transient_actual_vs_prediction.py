...
def draw_transient_actual_vs_prediction(y_, x_stats,p_start_t,load_path,x_stat,epoch,scenario,val_ground_truth_all):
    '''
    ...
    full_ground_truth = val_ground_truth_all
